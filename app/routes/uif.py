...
@uif_bp.route("/unemployment-calculator/", methods=["GET"])
def unemployment_calculator():
    return render_template("uif/unemployment/form.html")


@uif_bp.route("/unemployment-calculator/result", methods=["POST"])
def unemployment_calculator_result():
    try:
        ...
        logger.exception("Unexpected error in unemployment_calculator_result")
        raise


@uif_bp.route("/leave-benefit-calculator/", methods=["GET"])
def leave_benefit_calculator():
    return render_template("uif/leave/form.html")


@uif_bp.route("/leave-benefit-calculator/result", methods=["POST"])
def leave_benefit_calculator_result():
